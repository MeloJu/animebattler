...
INSERT INTO "new_User" ("createdAt", "email", "id", "name", "passwordHash", "selectedCharacterId", "updatedAt") SELECT "createdAt", "email", "id", "name", "passwordHash", "selectedCharacterId", "updatedAt" FROM "User";
DROP TABLE "User";
...
INSERT INTO "new_UserCharacter" ("characterId", "experience", "id", "level", "nickname", "npcWins", "pointsAvailable", "pvpWins", "userId") SELECT "characterId", "experience", "id", "level", "nickname", "npcWins", "pointsAvailable", "pvpWins", "userId" FROM "UserCharacter";
