...
const stages = [
  {
    ...
    enemyMonsterName: 'Hollow',
      ...
      { speaker: null, text: "Não é um inimigo do Seireitei. É só a primeira coisa que apareceu." },
        ...
        outroDialogue: [
      { speaker: null, text: "O Hollow se desfaz em partículas de reiatsu antes mesmo de tocar o chão." },
      { speaker: null, text: "Foi fácil. Fácil demais para o que vem depois daquele muro." },
    ],
    enemyLevel: 1,
    xpReward: 100,
    coinReward: 40,
  },
  {
    ...
    bossAttack: 28,
      ...
      { speaker: "Izuru Kira", text: "Cada vez que eu te acertar, você vai ficar mais pesado. Até não conseguir levantar." },
        ...
        outroDialogue: [
      { speaker: null, text: "Kira cai de joelhos, ainda tentando erguer a Wabisuke." },
      { speaker: "Izuru Kira", text: "Eu não pedi para estar aqui. Obedecer era a única coisa que tinha sobrado." },
      { speaker: "Izuru Kira", text: "Vai. Antes que eu me lembre da ordem." },
    ],
    enemyLevel: 2,
    xpReward: 200,
    coinReward: 60,
  },
  {
    ...
    enemyCharacterName: 'Renji Abarai',
      ...
      { speaker: "Renji Abarai", text: "Então prova que vale mais que eu. Vem." },
        ...
        outroDialogue: [
      { speaker: null, text: "Zabimaru se recolhe segmento por segmento. Renji fica de pé, mas só." },
      { speaker: "Renji Abarai", text: "Droga. Droga!" },
      { speaker: "Renji Abarai", text: "Se você chegar lá... não deixa ela ver você perdendo. Ela odeia isso." },
    ],
    enemyLevel: 3,
    xpReward: 300,
    coinReward: 90,
  },
  {
    ...
    bossEnergy: 125,
      ...
      { speaker: null, text: "Ele nem sabe o nome da própria espada. Nunca precisou." },
        ...
        outroDialogue: [
      { speaker: null, text: "Kenpachi cai sentado, rindo, com sangue escorrendo pelo queixo." },
      { speaker: "Kenpachi Zaraki", text: "Fazia tempo. Faz MUITO tempo que eu não sentia isso." },
      { speaker: "Kenpachi Zaraki", text: "Some daqui antes que eu levante. Eu ia querer de novo." },
    ],
    enemyLevel: 5,
    xpReward: 900,
    coinReward: 130,
  },
  {
    ...
    bossEnergy: 168,
      ...
      { speaker: null, text: "Ashisogi Jizō se abre em três lâminas. O veneno já está no ar antes do primeiro golpe." },
        ...
        outroDialogue: [
      { speaker: null, text: "Mayuri se dissolve num líquido que não deveria ser sangue, e a poça escoa pelo ralo." },
      { speaker: "Mayuri Kurotsuchi", text: "Interessante... eu não havia previsto... esta variável..." },
      { speaker: null, text: "A voz continua depois do corpo sumir. Ele não morreu — ele saiu." },
    ],
    enemyLevel: 7,
    xpReward: 1300,
    coinReward: 180,
  },
  {
    ...
    bossSpeed: 27,
      ...
      { speaker: "Byakuya Kuchiki", text: "Você não vai ver os cortes. Ninguém vê." },
        ...
        outroDialogue: [
      { speaker: null, text: "As lâminas caem no chão como pétalas de verdade, e param." },
      { speaker: "Byakuya Kuchiki", text: "Eu segui as regras a vida inteira. Foi assim que perdi minha esposa." },
      { speaker: "Byakuya Kuchiki", text: "Vá. Antes que eu me lembre de quem eu deveria ser." },
    ],
    enemyLevel: 9,
    xpReward: 1700,
    coinReward: 240,
  },
  {
    ...
    bossSpeed: 30,
      ...
      { speaker: "Gin Ichimaru", text: "Você vai descobrir isso agora, ou daqui a pouco. Tanto faz pra mim." },
        ...
        outroDialogue: [
      { speaker: null, text: "Gin recua um passo, e pela primeira vez os olhos dele se abrem." },
      { speaker: "Gin Ichimaru", text: "Ah... que pena. Eu ia gostar de ver como isso terminava." },
      { speaker: "Gin Ichimaru", text: "Mas ó, um conselho: o que está lá em cima não luta como eu." },
    ],
    enemyLevel: 11,
    xpReward: 2100,
    coinReward: 320,
  },
  {
    ...
    bossEnergy: 224,
      ...
      { speaker: "Sosuke Aizen", text: "Ninguém nunca esteve no topo do céu. Nem você, nem eu. Ainda." },
        ...
        outroDialogue: [
      { speaker: null, text: "Aizen recua. Não cai — recua. É a primeira vez que alguém o faz recuar." },
      { speaker: "Sosuke Aizen", text: "Curioso. Nada nisto estava previsto por mim." },
      { speaker: "Sosuke Aizen", text: "Guarde isso. É a única coisa que você tirou de mim hoje." },
      { speaker: null, text: "O Sōkyoku está em ruínas, e Rukia está viva. Por enquanto, é o bastante." },
    ],
    enemyLevel: 14,
    xpReward: 2500,
    coinReward: 500,
