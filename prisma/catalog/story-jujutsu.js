...
const stages = [
  {
    ...
    bossEnergy: 110,
      ...
      { speaker: "Megumi Fushiguro", text: "Nue. Sai." },
        ...
        outroDialogue: [
      { speaker: null, text: "O shikigami se desfaz em fumaça. Megumi assente uma vez, de leve." },
      { speaker: "Megumi Fushiguro", text: "Tá. Você não é inútil." },
      { speaker: null, text: "Vindo dele, isso é elogio." },
    ],
    enemyLevel: 1,
    xpReward: 100,
    coinReward: 40,
  },
  {
    ...
    bossEnergy: 80,
      ...
      { speaker: "Nobara Kugisaki", text: "Eu não aviso. E não vou pedir desculpa depois." },
        ...
        outroDialogue: [
      { speaker: null, text: "Nobara sacode a poeira da saia, mais irritada com a poeira do que com a derrota." },
      { speaker: "Nobara Kugisaki", text: "Tá. Você presta." },
      { speaker: "Nobara Kugisaki", text: "Mas se contar pro Itadori que eu disse isso, eu te prego na parede." },
    ],
    enemyLevel: 2,
    xpReward: 200,
    coinReward: 60,
  },
  {
    ...
    enemyCharacterName: 'Jogo',
      ...
      { speaker: null, text: "A fenda na cabeça dele se abre. O que sai não é fumaça." },
        ...
        outroDialogue: [
      { speaker: null, text: "O calor cede de uma vez, e o chão de Shibuya volta a ser chão." },
      { speaker: "Jogo", text: "Você... não sente medo de mim. Por quê?" },
      { speaker: null, text: "Ele recua sem morrer. Maldição daquele porte não morre de primeira." },
    ],
    enemyLevel: 3,
    xpReward: 300,
    coinReward: 90,
  },
  {
    ...
    bossEnergy: 85,
      ...
      { speaker: "Hanami", text: "Eu não sou a floresta." },
        ...
        outroDialogue: [
      { speaker: null, text: "A casca racha e o que havia dentro se dispersa em esporos." },
      { speaker: "Hanami", text: "Vocês... vão continuar... crescendo onde não deviam..." },
      { speaker: null, text: "Por um instante o ar cheira a mato molhado. Depois volta a cheirar a metrô." },
    ],
    enemyLevel: 5,
    xpReward: 900,
    coinReward: 130,
  },
  {
    ...
    bossEnergy: 200,
      ...
      { speaker: "Mahito", text: "Fica quieto. Vai ser rápido, ou não." },
        ...
        outroDialogue: [
      { speaker: null, text: "Mahito se desfaz rindo. O riso continua depois do corpo sumir." },
      { speaker: "Mahito", text: "Que peninha. Eu ia me divertir tanto com a sua alma." },
      { speaker: null, text: "Você não tem certeza se venceu ou se ele desistiu." },
    ],
    enemyLevel: 7,
    xpReward: 1300,
    coinReward: 180,
  },
  {
    ...
    bossDefense: 14,
      ...
      { speaker: "Satoru Gojo", text: "Vem. Sem medo, senão não vale." },
        ...
        outroDialogue: [
      { speaker: null, text: "Gojo recoloca a venda, sem pressa." },
      { speaker: "Satoru Gojo", text: "Nada mal. Sério." },
      { speaker: "Satoru Gojo", text: "Isso não foi vitória, foi permissão. Mas eu ia te dar de qualquer jeito." },
    ],
    enemyLevel: 9,
    xpReward: 1700,
    coinReward: 240,
  },
  {
    ...
    enemyCharacterName: 'Suguru Geto',
      ...
      { speaker: null, text: "Atrás dele, espíritos amaldiçoados se acumulam até tapar o corredor." },
        ...
        outroDialogue: [
      { speaker: null, text: "Os espíritos amaldiçoados se dispersam sem dono." },
      { speaker: "Suguru Geto", text: "Este corpo já deu o que tinha que dar. Eu arranjo outro." },
      { speaker: null, text: "O que estava usando aquele rosto sai andando. E o Prisma continua selado." },
    ],
    enemyLevel: 11,
    xpReward: 2100,
    coinReward: 320,
  },
  {
    ...
    bossSpeed: 28,
      ...
      { speaker: null, text: "Ele levanta um dedo. Só um." },
        ...
        outroDialogue: [
      { speaker: null, text: "Sukuna baixa o dedo. Não cai, não recua — só perde o interesse." },
      { speaker: "Ryomen Sukuna", text: "Hm. Você durou." },
      { speaker: "Ryomen Sukuna", text: "Vou lembrar do seu nome. Não é elogio." },
      { speaker: null, text: "Ele se recolhe para dentro do hospedeiro como quem guarda uma faca. Shibuya acabou. Ele não." },
    ],
    enemyLevel: 14,
    xpReward: 2500,
    coinReward: 500,
