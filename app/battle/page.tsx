  ...
  return (
    <main className="mx-auto max-w-7xl p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <Link href="/battle/raid" className="card p-6 hover:shadow-lg transition-shadow">
          <h3 className="font-semibold">Raid</h3>
          <p className="text-sm mt-1 opacity-70">Fight a Hollow for bonus rewards.</p>
        </Link>
